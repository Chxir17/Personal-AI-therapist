...
public class ParseUserPrompt {
    ...
    public String initPromptParser(String userMessage) throws InterruptedException {
        ...
        String systemPrompt = """
                ...
                - "male" — пол пользователя (true, если мужчина; false, если женщина; null, если не упоминается)
                ...
                [Инструкция]:
                1. Если какое-либо поле не было упомянуто пользователем, используй значение null.
                2. Обязательно учитывай указанные типы данных. Например, если возраст указан строкой ("20 лет"), преобразуй его в целое число (20), но если указана единица измерения, которая не соответствует типу данных (например, "вес = 150 фунтов"), преобразуй данное значение в указанные единицы измерения.
