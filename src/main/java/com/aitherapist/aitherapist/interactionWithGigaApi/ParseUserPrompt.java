...
- "pressure" — артериальное давление(float)
...
2. Если пользователь указывает, что какой-либо параметр «в норме», «в порядке», «без отклонений» или даёт аналогичную формулировку, запиши для него **среднее нормальное значение**:
...
""";
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        String userPrompt = "Сколько будет 2+2";
        String userHealthData = "давление 140 пульс 70 спал 8 часов температура нормальная";
